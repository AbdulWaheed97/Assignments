...
cocacola = pd.read_excel("D:/Airlines Data.xlsx")
...
cocacola = pd.read_excel("D:/PlasticSales.csv")
...
cocacola = pd.read_excel("D:/CocaCola_Sales_Rawdata.xlsx")
...
newdata_pred = hwe_model_add_add.predict(start = new_data.index[0].
